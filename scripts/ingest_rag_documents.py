...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ingest project documentation into the configured RAG repository.")
    parser.add_argument("paths", nargs="*", default=["README.md", "docs"])
    args = parser.parse_args()

    load_project_env()
    result = get_rag_service().ingest_paths(args.paths)
