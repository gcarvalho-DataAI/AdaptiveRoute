...
The selected adapter is \path{outputs/models/adaptiveroute-qwen2_5-7b-lora-error20k-v5}, with the
stable operational alias \path{outputs/models/adaptiveroute-routing-policy-current}.
